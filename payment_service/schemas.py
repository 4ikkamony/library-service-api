...
renew_stripe_session_schema = extend_schema(
    parameters=[
        ...
        responses={
                ...
                'content': {
                    'application/json': {
                        'schema': {
                            'type': 'object',
                            'properties': {
                                'message': {'type': 'string', 'example': 'Payment session renewed'},
                                'session_url': {'type': 'string', 'example': 'https://checkout.stripe.com/...' },
                            },
                        },
                    },
                },
            ...
            400: {
                'description': 'Bad request (missing payment_id, payment not expired, Stripe error)',
                'content': {
                    'application/json': {
                        'schema': {
                            'type': 'object',
